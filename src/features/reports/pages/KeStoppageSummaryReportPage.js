...
const STORAGE_KEY = "vtp_ke_stoppage_summary_saved_filter_v1";
...
export default function KeStoppageSummaryReportPage({ menuKey = "", accessMenuKey = menuKey }) {
                      ...
                      <>
                        {summaryRow ? (
                          <tr className={styles.summaryAggregateRow}>
                            ...
                            <td />
                            {KE_REPORT_HIERARCHY_COLUMNS.map((column) => (
                              <td key={`stoppage-summary-${column.key}`} />
                            ))}
                            <td />
                            <td />
                            <td />

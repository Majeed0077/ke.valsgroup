...
const STORAGE_KEY = "vtp_ke_trip_summary_saved_filter_v1";
...
export default function KeTripSummaryReportPage({ menuKey = "", accessMenuKey = menuKey }) {
                ...
                <table className={`${styles.summaryTable} ${hasApplied ? styles.summaryTableResult : ""}`}>
                  ...
                  <thead>
                    <tr>
                      ...
                      {KE_REPORT_HIERARCHY_COLUMNS.map((column) => (
                        <th key={column.key} rowSpan={2}><span className={styles.headerLabel}><span>{column.label}</span></span></th>
                      ))}
                  ...
                  <tbody>
                    {hasApplied && appliedRows.length ? (
                      <>
                        {summaryRow ? (
                          <tr className={styles.summaryAggregateRow}>
                            ...
                            <td />
                            {KE_REPORT_HIERARCHY_COLUMNS.map((column) => (
                              <td key={`trip-summary-${column.key}`} />
                            ))}
                            <td />
                            <td />
                            <td />
                            ...
                            <React.Fragment key={row.id}>
                              ...
                              {expanded ? (
                                <tr className={styles.detailOuterRow}>
                                  <td colSpan={MAIN_TABLE_COLSPAN} className={styles.detailCell}>
                      ...
                      <>
                        <tr>
                          <td colSpan={MAIN_TABLE_COLSPAN} className={styles.noDataRow}>
                            No Records Found
                          </td>
                        </tr>
                        <tr>
                          <td colSpan={MAIN_TABLE_COLSPAN} className={styles.gridFillCell}>

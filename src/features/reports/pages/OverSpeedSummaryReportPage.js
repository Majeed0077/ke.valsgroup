...
const STORAGE_KEY = "vtp_over_speed_summary_saved_filter_v1";
...
export default function OverSpeedSummaryReportPage({ menuKey = "" }) {
  ...
  const handleExport = (type) => {
    ...
    const headers = ["Branch", "Object", "Object Brand", "Object Model", "Driver", "No Of Time", "Duration"];
    const rows = appliedRows.map((row) => [row.branch, row.object, row.brand, row.model, row.driver, row.noOfTime, row.duration]);
                    ...
                    <table className={styles.activityTable}>
                      ...
                      <tbody>
                        {appliedRows.length ? (
                          ...
                          <tr>
                            <td colSpan={7} className={styles.noDataRow}>No Records Found</td>
                          </tr>
                        )}
                      </tbody>
                    </table>
              ...
              <div className={styles.tableShell}>
                <div className={styles.tableScroller}>
                  <table className={styles.summaryTable}>
                    ...
                    <tbody>
                      <tr><td colSpan={7} className={styles.noDataRow}>No Records Found</td></tr>
                      <tr><td colSpan={7} className={styles.gridFillCell}><div className={styles.gridFillArea} /></td></tr>
                    </tbody>
                  </table>
                </div>
              </div>

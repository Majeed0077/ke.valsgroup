...
const STORAGE_KEY = "vtp_ke_travel_summary_saved_filter_v1";
...
const MAIN_COLUMNS = [
  ...
  ...KE_REPORT_HIERARCHY_COLUMNS.map((column) => ({ key: column.key, label: column.label })),
...
export default function KeTravelSummaryReportPage({ menuKey = "", accessMenuKey = menuKey }) {
                        ...
                        {summaryRow ? (
                          <tr className={styles.summaryAggregateRow}>
                            ...
                            {KE_REPORT_HIERARCHY_COLUMNS.map((column) => (
                              <td key={`travel-summary-${column.key}`} />
                            ))}
                            <td />
                            <td />
                            <td />
